...
const Description = () => {
  return (
    <div
      id="description"
      className="bg-gradient-to-t from-neutral-50 via-neutral-200 to-neutral-300 dark:from-neutral-900 dark:via-neutral-800 dark:to-neutral-700 p-10 flex justify-center"
    >

...
const Unread = () => {
  ...
  return (
    <div className="relative">
      <div
        className="relative h-4 w-4 cursor-pointer grid place-content-center hover:bg-neutral-300 rounded dark:hover:bg-neutral-700"
        onClick={handleOpenNotifs}
      >
        <Icon icon={"material-symbols:post-outline"} className="h-6 w-6" />
        <p className="absolute -bottom-2 -right-2 h-4 w-4 font-extrabold grid place-content-center bg-black dark:bg-white text-white rounded-full dark:text-black text-[10px]">

...
const LoginTemplate: React.FC<Props> = ({ children }) => {
  ...
  return (
    <div className="md:h-screen bg-gradient-to-b pb-52 sm:pb-0 from-white dark:from-black via-neutral-100 dark:via-neutral-800 to-neutral-300 dark:to-neutral-800">
